...
class VideoRecorder:
    ...
    target = 'rtsp://demo:demo@ipvmdemo.dyndns.org:5541/onvif-media/media.amp?profile=profile_1_h264&sessiontimeout=60&streamtype=unicast'
    file = 'record.avi'
    ...
    def record_video(self, upload_interval=10):
